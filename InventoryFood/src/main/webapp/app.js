...
angular.module('app', ['ui.router','ui.bootstrap', 'ngSanitize',  'ngAnimate', 'ngMaterial', 'ngMessages', 'material.svgAssetsCache'])
        .controller('myCtrl',function ($scope, $http, $uibModal,$timeout) {
...
$scope.newItem = {itemName:'', typeId:'', brand:'', quantity:0, unit:'', dateOfPurchase:'', dateOfExpiry:'', location: $scope.selectedCity};

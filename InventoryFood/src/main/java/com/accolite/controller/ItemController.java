...
public class ItemController {
	...
	public ModelAndView login(@RequestParam("emailID") String emailID) {
		...
		if (emailID.equals("pawan.prakash@accoliteindia.com")) {
			model = new ModelAndView(new RedirectView("http://localhost:8081/InventoryFood/index.html"));
		} else {
			model = new ModelAndView(new RedirectView("http://localhost:8081/InventoryFood/userIndex.html"));
		}
		return model;
	}
